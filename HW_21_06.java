...
public class HW_21_06 {
    ...
    // на табло понятные фразы с информацией о том, сколько полных часов осталось
    // до конца рабочего дня.
    // Например: «осталось 7 часов», «осталось 4 часа», «остался 1 час», «осталось менее часа».
    // Обьяснение: в переменную n должно записываться случайное
    // (на время тестирования программы) целое число из диапазона от 0 до 28800,
    // далее оно должно выводиться на экран (для тех сотрудников, кто понимает в секундах)
    // и на следующей строке (для тех сотрудников, кто не понимает) должна выводиться фраза
    // о количестве полных часов, содержащихся в n секундах.

    public static void main(String[] args) {

        int s = (int) (Math.random() * 28800 + 1);
        System.out.println("осталось секунд:" + s);
        System.out.println("осталось часов: " + (s / 60 /60));
    }
}
